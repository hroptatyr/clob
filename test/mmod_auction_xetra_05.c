...
main(void)
{
	...
	/* xetra example 5 */
	clob_add(c, (clob_ord_t){TYPE_LMT, SIDE_ASK, 300.dd, 0.0dd, .lmt = 202.0dd});
	clob_add(c, (clob_ord_t){TYPE_LMT, SIDE_ASK, 200.dd, 0.0dd, .lmt = 201.0dd});
	clob_add(c, (clob_ord_t){TYPE_LMT, SIDE_BID, 100.dd, 0.0dd, .lmt = 200.0dd});
	clob_add(c, (clob_ord_t){TYPE_LMT, SIDE_BID, 400.dd, 0.0dd, .lmt = 199.0dd});
